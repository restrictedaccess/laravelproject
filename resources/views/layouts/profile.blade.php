  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="f20">If you leave this page you will go back to the start of the questionnaire. Are you sure?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-negative" data-dismiss="modal">No, stay on this page</button>
        <button type="button" class="btn btn-primary" id="btn-modal-ok">OK, go back to the start</button>
      </div>
    </div>
  </div>
</div>
...
<div class="content">
    <div class="content__padded">
        <div class="profile_content">
            <h3 class="reason_profile">We'll show your Risk Reduction Score in just a moment. But first we need to learn a little more about you so we can store your results and offer you important lifestyle tips.</h3><br>
            <h3 class="title_profile">Your Profile</h3>
            @if(App::environment('local'))
            {!! Form::open(['method' => 'POST' , 'id'=>'form_profile', 'class'=>'input-group', 'url'=> URL::to('/rrs/score', array(), false) ]) !!}
            @else
            {!! Form::open(['method' => 'POST' , 'id'=>'form_profile', 'class'=>'input-group', 'url'=> URL::to('/rrs/score', array(), true) ]) !!}
            @endif
            <div class="input-row">
                <label class="label__profile" for="first_name">First Name <span class="compulsory__status">*</span></label>
                <div class="input-control ml96">
            ...
            <div class="input-row">
                ...
                <div class="input-control ml108">
                    <input class="input__profile js-answer-key" id="birthday" type="date" name="birthday" value="1960-01-01" placeholder="yyyy/mm/dd">
            ...
            <div class="input-row">
              ...
              <p class="para_terms" style="font-size:1.7rem;color:#000">I want to receive brainsalvation news and personalized information from Pegara.</p>
                    <div class="checkbox__styled p0 mt15">
                        <input type="checkbox" class="checkbox__styled__input" id="checkbox-2" name="news_letter_flag" value="yes" @if(old('news_letter_flag') == "yes" || old('news_letter_flag')==null) checked="" @endif>
                        <label class="checkbox__styled__label" for="checkbox-2">I want to receive brainsalvation news and personalized information from Pegara. <span class="compulsory__status">*</span></label>
                    </div>
                </div>
              <p class="para_terms">By clicking the button below. I agree with the Pegara <a class="link_terms" target="_blank" href="/terms">Terms of Service</a> and <a class="link_terms" target="_blank" href="/privacy">Privacy Policy</a>.</p>
            </div>
            <div class="check__score">
                <button id="profile-back-btn" data-toggle="modal" data-target="#modal-confirm" type="button" class="btn btn-block btn__regular btn__back">BACK</button>
              <button id="profile-submit-btn" class="btn btn__regular js-submit-button" type="submit">Check your score!</button>
            </div>
            </br>
            {!! Form::close() !!}
        </div>
