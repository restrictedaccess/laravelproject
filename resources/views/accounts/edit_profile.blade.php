...
<div class="content p-t-6">
  <div class="content__padded">
    <div class="profile_content">
      <h3 class="title_profile">Edit Profile</h3>
      ...
      <div class="check__score">
        <button id="profile-submit-btn" class="btn btn__regular" type="submit">Save Profile</button>
        <button id="cancel-btn" class="btn btn__regular btn-info" type="submit">Cancel</button>
      </div>
      <div class="input-row">
        <div>
          <a class="text-center dis-block" target="_blank" href="">Delete Account</a>.
        </div>
      </div>
    </br>
    {!! Form::close() !!}
