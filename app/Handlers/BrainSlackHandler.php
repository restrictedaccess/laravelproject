 ...
 */
class BrainSlackHandler extends SocketHandler
{
    /**
     * Slack API token
     * @var string
     ...
     */
    public function __construct($token, $channel, $username = 'Monolog', $useAttachment = true, $iconEmoji = null, $level = Logger::CRITICAL, $bubble = true, $useShortAttachment = false, $includeContextAndExtra = true)
    {
    ...
    protected function prepareContentData($record)
    {
        ...
        if ($this->useAttachment) {
            ...
            $attachment['fields']['environment'] = array(
                'title' => 'Environment',
